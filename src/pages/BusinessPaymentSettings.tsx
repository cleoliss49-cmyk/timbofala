...
export default function BusinessPaymentSettings() {
  ...
  const fetchBusiness = async () => {
    try {
      const { data: businessData, error: businessError } = await supabase
        ...
        .select('id, business_name, pix_key, pix_key_type, pix_holder_name')
        .eq('user_id', user!.id)
        .maybeSingle();
  ...
  const savePixSettings = async () => {
    ...
    if (pixData.pix_key && !pixData.pix_holder_name) {
      toast({
    ...
    try {
      ...
      toast({
        ...
        description: 'Suas configurações de PIX foram atualizadas'
      });
    } catch (error) {
    ...
    <MainLayout>
      <div className="max-w-4xl mx-auto p-4 space-y-6">
        ...
        <Alert>
          ...
          <AlertDescription>
            Cadastre sua chave PIX para receber pagamentos. O usuário efetuará o pagamento diretamente 
            em sua conta. <strong>Não intermediamos pagamentos e não cobramos taxas</strong>.
          </AlertDescription>
        </Alert>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-end">
              <Button onClick={savePixSettings} disabled={saving}>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              >
                ...
                <SelectContent>
                  {NEIGHBORHOODS.filter(n => !deliveryZones.some(z => z.neighborhood === n)).map((neighborhood) => (
